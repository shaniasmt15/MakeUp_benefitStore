        ...
        <div class="w3-main" style="margin-left:250px">
            ...
            <!--start: Wrapper-->
             <div id="w3-container w3-xlarge">
                    ...
                    <div class="row">
                        <?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM brows ORDER BY br_id DESC limit 9");
                    ...
                    ?>
                            <div class="span4">
                                <div class="icons-box">
                                    ...
                                    <div class="clear"><a href="detailbrows.php?kd=<?php echo $data['br_id'];?>" class="btn btn-lg btn-info">Detail</a>
                                        <a href="detailbrows.php?kd=<?php echo $data['br_id'];?>" class="btn btn-lg btn-info">Beli &raquo;</a></div>
