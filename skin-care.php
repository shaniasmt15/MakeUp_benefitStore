...
?>
    ...
    <!DOCTYPE html>
    <html>
    <title>Benefit Cosmetic's - Skin Care </title>
    <meta charset="UTF-8">
 ...
 <!-- Top menu on small screens -->
        ...
        <div class="w3-main" style="margin-left:250px">
            ...
            <header class="w3-container w3-xlarge" style="margin-top:40px">
                <p class="w3-left">
                    <font style="Segoe Script">Benefit Makeup - Skin Care</font>
                </p>
                <p class="w3-right ">
            ...
            <div id="w3-container w3-xlarge">
                    ...
                    <div class="row">
                        <?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM skincare ORDER BY br_id DESC limit 9");
                    ...
                    ?>
                            <div class="span4">
                                <div class="icons-box">
                                    ...
                                    <div class="clear"><a href="detailskincare.php?kd=<?php echo $data['br_id'];?>" class="btn btn-lg btn-info">Detail</a>
                                        <a href="detailskincare.php?kd=<?php echo $data['br_id'];?>" class="btn btn-lg btn-info">Beli &raquo;</a></div>
