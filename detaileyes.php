...
?>
    ...
    <!DOCTYPE html>
    <html>
    <title>Benefit Cosmetic's - Eyes</title>
    <meta charset="UTF-8">
    ...
    <body class="w3-content" style="max-width:1350px">
        ...
        <div class="w3-main" style="margin-left:250px">
            ...
            <header class="w3-container w3-xlarge">
                <p class="w3-left">
                    <font style="Segoe Script">Benefit Makeup - Eyes</font>
                </p>
                <p class="w3-right ">
    ...
    if (isset($_SESSION['items'])) {
        foreach ($_SESSION['items'] as $key => $val) {
            $query = mysqli_query($koneksi, "SELECT br_id, br_nm, br_hrg FROM eyes WHERE br_id = '$key'");
            ...
            ?>
				...
				?>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <?php                  
$query = mysqli_query($koneksi, "SELECT * FROM eyes WHERE br_id='$_GET[kd]'");
$data  = mysqli_fetch_array($query);
?>
                            <!--<div class="span4">-->
                            <!--<div class="icons-box">-->
                            <div class="hero-unit" style="margin-left: 20px;">
	                           ...
	                           echo '<strong style="color: red;">Out Of Stock</strong>';	
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <div class="clear"> <a href="detailcart.php?act=add&amp;barang_id=<?php echo $data['br_id']; ?>&amp;ref=detailbrows.php?kd=<?php echo $data['br_id'];?>" class="btn btn-lg btn-info">Beli &raquo;</a></div>
                                        </td>
                                    </tr>
