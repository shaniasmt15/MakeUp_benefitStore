...
?>
    ...
    <body class="w3-content" style="max-width:1350px">
        ...
        <div class="w3-main" style="margin-left:250px">
            ...
            <!-- Top header -->
            <header class="w3-container w3-xlarge" style="margin-top:83px">
                <p class="w3-left">
    ...
    if (isset($_SESSION['items'])) {
        foreach ($_SESSION['items'] as $key => $val) {
            $query = mysqli_query($koneksi, "SELECT br_id, br_nm, br_hrg FROM skincare WHERE br_id = '$key'");
            ...
            ?>
				...
				?>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <?php                  
$query = mysqli_query($koneksi, "SELECT * FROM skincare WHERE br_id='$_GET[kd]'");
$data  = mysqli_fetch_array($query);
?>
                            <!--<div class="span4">-->
                            <!--<div class="icons-box">-->
