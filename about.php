...
?>
    ...
    <!DOCTYPE html>
    <html>
    <title>Benefit Cosmetic's - About</title>
    <meta charset="UTF-8">
    ...
    <body class="w3-content" style="max-width:1350px">
        ...
        <div class="w3-main" style="margin-left:250px">
            ...
            <header class="w3-container w3-xlarge" style="margin-top:40px">
                <p class="w3-left">
                    <font style="Segoe Script">Benefit Makeup - About</font>
                </p>
                <p class="w3-right ">
            ...
            <div id="w3-container w3-xlarge">
                ...
                <div class="row">
                    ...
                    <div class="span4">
                        <div class="icons-box">
                            <img src="images/sania.JPG" />
                            <div>
                                <h3> Shania Shamanta</h3>

                                <h6><i class="fa fa-fw fa-envelope"></i> shania16ti@mahasiswa.pcr.ac.id</h6>

                                <h6><i class="fa fa-fw fa-map-marker"></i>Jl. Telagasari no.7B </h6>
                            </div>
                    ...
                    <!---->
                     <div class="span4">
                        <div class="icons-box">
                            <img src="images/popi.PNG" />
                            <div>
                                <h3>Poppy Apriola Saragih </h3>

                                <h6><i class="fa fa-fw fa-envelope"></i> poppy16ti@mahasiswa.pcr.ac.id</h6>

                                <h6><i class="fa fa-fw fa-map-marker"></i>Jl. Berdikari</h6>
                            </div>
